    ...
    if tenant_slug not in _session_factories:
        with _lock:
            if tenant_slug not in _session_factories:
                ...
                # Una sola vez por tenant y por proceso: las bases aprovisionadas antes de
                # RF-08 no tienen las columnas de conocimiento validado, y sin esto el
                # primer acceso fallaría con «columna inexistente».
