...
class ProductResponse(BaseModel):
    ...
    description: str = Field(
        ...
        examples=["Licencia de software anual"],
    )
    ...
    raw_payload: dict[str, Any] = Field(
        ..., description="Datos originales usados para crear/actualizar el producto."
    )
...
class ImportProductsResponse(BaseModel):
    ...
    products: list[ProductResponse] = Field(
        ..., description="Productos almacenados despues de la importacion."
    )
