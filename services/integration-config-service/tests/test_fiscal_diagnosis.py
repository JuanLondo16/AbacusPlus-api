...
_COMPROBANTE = {
    "id": 19693, "code": "1", "name": "Compra", "type": "FC",
    "cost_center_mandatory": True, "reteiva": True, "reteica": True,
}
...
class TestComparacionDeTerceros:
    def test_cuando_coinciden_no_hay_nada_que_corregir(self):
        d = comparar_tercero("830048145", "SIIGO SAS", "R-99-PN",
    ...
    def test_detecta_el_autorretenedor_que_falta_en_siigo(self):
        ...
        d = comparar_tercero("900123456", "PROVEEDOR SAS", "O-13;O-15",
    ...
    def test_detecta_codigos_que_sobran_en_siigo(self):
        ...
        d = comparar_tercero("900123456", "PROVEEDOR SAS", "O-13",
    ...
    def test_una_diferencia_sin_autorretenedor_no_afecta_la_retencion(self):
        d = comparar_tercero("900123456", "X", "O-47",
                             {"fiscal_responsibilities": [{"code": "R-99-PN"}]})
...
class TestComparacionDeLaEmpresa:
    def test_lo_declarado_y_habilitado_coincide(self):
        d = comparar_empresa(_perfil(agente_retencion_iva=True, agente_retencion_ica=True),
                             _COMPROBANTE)
    ...
    def test_el_caso_real_del_cliente(self):
        ...
        d = comparar_empresa(
            _perfil(agente_retencion_renta=True, agente_retencion_ica=True,
